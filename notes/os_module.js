...
os.arch()   // check oprating system archetecture  i-e 64bit,32bit
os.freemem()   // to check free memory of system ram
os.totalmem()   // to check totle system ram memory
 os.hostname()  // checck sytem host name
 os.platform()  // oprating system
 os.tmpdir()    // path of temperary file
 os.type()      // oprating system
